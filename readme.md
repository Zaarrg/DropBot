...
<p align="center">
     <b>Select <code>Twitch Drops</code> to watch a Twitch Campaign or <code>Custom Channels</code> if you want to add your own channels. Refer to <a href="http://example.net/">Step by Step Usage: Custom Channels</a> for those.</b><br/>
</p>
...
**3. Step**
<p align="center">
    <b>Select the campaign you want to start watching. If you want to only watch certain campaign and not all refer to <a href="http://example.net/">Settings: Priority list</a></b><br/>
</p>
