...
export async function pointsCheck(channelLogin: string) {
    ...
    const pointsrequest = await GQL._SendQuery("ChannelPointsContext", opts, '1530a003a7d374b0380b79db0be0534f30ff46e61cffa2bc0e2468a909fbc024', 'OAuth ' + userdata.auth_token, true, {}, true)
...
async function checkisClaimeable(request:any, channelId: string) {
    let ClaimId = '';
    try {
    ...
    if (ClaimId !== '') {
        ...
        const claimrequest = await GQL._SendQuery("ClaimCommunityPoints", opts, '46aaeebe02c99afdf4fc97c7c0cba964124bf6b0af229395f1f6d1feed05b3d0', 'OAuth ' + userdata.auth_token, true, {}, true);
